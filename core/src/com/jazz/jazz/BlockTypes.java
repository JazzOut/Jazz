...
public enum BlockTypes {
	...
	REG_BLOCK(new ModelBuilder().createBox(10, 5, 5, new Material(ColorAttribute.createDiffuse(Color.BLUE)), Usage.Normal | Usage.Position), "rectangle", BodyType.DynamicBody, .1f, .5f, 0f),
